namespace :leagues do
  ...
  task create_with_teams: :environment do
    # TODO: move functionality to services: LeagueCreator, used with Users::Creator
    ...
    leagues_data.each do |league_name, league_data|
      ...
      league_data['members'].each do |team_name, user_email|
        ...
        if team
          ...
          Team.create(name: team_name, user: user, league: league, code: team_name.upcase[0..2], human_name: team_name.titleize[0..18])
        end
      end
    end
    puts 'Done!'
