RSpec.describe TelegramBot::Auction::SalesDdlNotifier do
  describe '#call' do
    ...
    let(:notification) { create(:notification, notifiable: auction, team: team, kind: :auction_sales_ddl) }
    ...
    context 'when team has a user' do
      ...
      it 'uses sales_ddl translation key' do
        ...
        expect(I18n).to have_received(:t).with('telegram.notifier.auction.sales_ddl', hash_including(locale: :ua))
      end
    end
  end
end
