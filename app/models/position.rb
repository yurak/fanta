...
class Position < ApplicationRecord
  ...
  CLASSIC_CLEANSHEET_ZONE = [PORTIERE, DIFENSORE_CENTRALE, DIFENSORE_SINISTRO, DIFENSORE_DESTRO].freeze
  CLEANSHEET_ZONE = [PORTIERE, DIFENSORE_CENTRALE, DIFENSORE_SINISTRO, DIFENSORE_DESTRO, MEDIANO].freeze
