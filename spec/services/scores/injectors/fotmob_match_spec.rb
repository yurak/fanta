RSpec.describe Scores::Injectors::FotmobMatch do
  describe '#call' do
    ...
    context 'with not finished match' do
      let(:match) { create(:tournament_match, source_match_id: 'inter-vs-arsenal/2tgrh0#4621502') }
    ...
    context 'with finished match' do
      let(:match) { create(:tournament_match, source_match_id: 'milan-vs-real-madrid/2g1pac#4621544') }
