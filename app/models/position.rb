...
class Position < ApplicationRecord
  ...
  DEPENDENCY = {
    ...
    WING_BACK => [WING_BACK, RIGHT_BACK, LEFT_BACK, WINGER],
    DEFENCE_MF => [DEFENCE_MF, CENTER_MF, CENTER_BACK],
    CENTER_MF => [CENTER_MF, DEFENCE_MF, ATTACKING_MF],
